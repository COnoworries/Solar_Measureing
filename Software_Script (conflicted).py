...
def main():
    ...
    while(1):
        ...
        if start_time_global + timedelta(seconds=x) - timedelta(seconds=0.5) > end_time_gloabl:
        ...
        SZ4 = np.array([])
        SZ5 = np.array([])
        print("print deleted arrays")
        print("x_data {}".format(x_data))
        print("y_data {}".format(y_data))
        print("z_data {}".format(z_data))
        print("SZ1 {}".format(SZ1))
        print("SZ2 {}".format(SZ2))
        print("SZ3 {}".format(SZ3))
        print("SZ4 {}".format(SZ4))
        print("SZ5 {}".format(SZ5))
        ...
        print("Abschnitt 2: {}".format(t2-t0))
        print("Abschnitt 3: {}".format(t3-t0))
